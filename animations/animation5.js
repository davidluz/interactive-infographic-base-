var animation5 = new Phaser.Game(301, 150, Phaser.CANVAS, 'animation5', {preload:preload,create: create, update: update });
...
function create() {
    ...
    var tween1 = animation5.add.tween(car7).to({ x: 200 }, 800, Phaser.Easing.Linear.None, true, 0, 0, false);
	var tween2 = animation5.add.tween(car8).to({ x: 100 }, 800, Phaser.Easing.Linear.None, true, 0, 0, false);
	var tween3 = animation5.add.tween(car9).to({ x: 50 }, 800, Phaser.Easing.Linear.None, true, 0, 0, false);
