...
function create() {
    ...
    var tween1 = animation2.add.tween(car3).to({ x: 0 }, 1500, Phaser.Easing.Linear.None, true, 0, 1000, false);
    var tween2 = animation2.add.tween(car4).to({ y: 35 }, 1500, Phaser.Easing.Linear.None, true, 0, 1000, false);
